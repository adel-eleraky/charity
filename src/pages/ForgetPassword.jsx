                        ...
                        <div className="col-12 col-md-10 col-xl-6">
                            {formStatus === "notSubmitted" ?
                                        ...
                                        {({ values, errors, touched }) => {
                                            return (
                                                <Form method="post" className="needs-validation" noValidate>
                                                    ...
                                                    <button type='submit' className="btn d-block m-auto submit-btn fw-bold">ارسل الرابط الى البريد</button>
                                                </Form>
                                            )
                                        }}
                                    </Formik>
                                ...
                                <div className='form-submitted-content text-center p-5 rounded w-75 m-auto'>
                                    <h3 className='mb-4'> تم ارسال الرابط الى بريدك الالكترونى</h3>
